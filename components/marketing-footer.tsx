...
const SITE_LINKS: FooterLink[] = [
  ...
  { label: "View source", href: GITHUB_URL, external: true },
];
...
/**
 * Same two-panel format as this project's siblings (Mimo, Insight): an
 * accent brand panel plus a flat links panel, both rounded on the top
 * corners only and flush at the bottom instead of floating as closed
 * rectangles — rebuilt against Match's own near-black/amber tokens rather
    ...
    <footer className="mkt-footer">
      <div className="mkt-footer-inner">
        <div className="mkt-footer-brand">
          <span className="mkt-footer-wordmark">match</span>

          <div className="mkt-footer-brand-foot">
            <p className="mkt-footer-tagline">Job hunting, automated.</p>

            <div className="mkt-footer-icon-row">
              {SOCIAL_LINKS.map(({ label, href, Icon }) => (
                <a
                  ...
                  aria-label={label}
                  className="mkt-footer-icon-link"
                >
                  <Icon />
                </a>
              ))}
            ...
            <p className="mkt-footer-copyright">&copy; {year} Match by Fil Heinz Re La Torre</p>
          </div>
        </div>

        <nav aria-label="Footer" className="mkt-footer-links">
          <h2 className="mkt-footer-col-title">Site</h2>
