...
-- Database: PostgreSQL
-- Generated from: prisma/schema.prisma + rls-policies.sql
-- ============================================================
...
-- Application Events
CREATE POLICY "application_events_select_own" ON "application_events" FOR SELECT
  USING (user_id = current_setting('app.current_user_id', TRUE));
CREATE POLICY "application_events_insert_own" ON "application_events" FOR INSERT
  WITH CHECK (user_id = current_setting('app.current_user_id', TRUE));

-- Follow-up Log
CREATE POLICY "follow_up_log_select_own" ON "follow_up_log" FOR SELECT
  USING (user_id = current_setting('app.current_user_id', TRUE));
CREATE POLICY "follow_up_log_insert_own" ON "follow_up_log" FOR INSERT
  WITH CHECK (user_id = current_setting('app.current_user_id', TRUE));
CREATE POLICY "follow_up_log_update_own" ON "follow_up_log" FOR UPDATE
  USING (user_id = current_setting('app.current_user_id', TRUE));

-- Interview Prep
CREATE POLICY "interview_prep_select_own" ON "interview_prep" FOR SELECT
  USING (user_id = current_setting('app.current_user_id', TRUE));
CREATE POLICY "interview_prep_insert_own" ON "interview_prep" FOR INSERT
  WITH CHECK (user_id = current_setting('app.current_user_id', TRUE));
CREATE POLICY "interview_prep_update_own" ON "interview_prep" FOR UPDATE
  USING (user_id = current_setting('app.current_user_id', TRUE));

-- Company Research
CREATE POLICY "company_research_select_own" ON "company_research" FOR SELECT
  USING (user_id = current_setting('app.current_user_id', TRUE));
CREATE POLICY "company_research_insert_own" ON "company_research" FOR INSERT
  WITH CHECK (user_id = current_setting('app.current_user_id', TRUE));
CREATE POLICY "company_research_update_own" ON "company_research" FOR UPDATE
  USING (user_id = current_setting('app.current_user_id', TRUE));

-- Tailored Resumes
CREATE POLICY "tailored_resumes_select_own" ON "tailored_resumes" FOR SELECT
  USING (user_id = current_setting('app.current_user_id', TRUE));
CREATE POLICY "tailored_resumes_insert_own" ON "tailored_resumes" FOR INSERT
  WITH CHECK (user_id = current_setting('app.current_user_id', TRUE));
